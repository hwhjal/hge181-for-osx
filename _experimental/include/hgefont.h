...
public:
    ...
    hgeFont(const char *szFont, void *data, DWORD size, HTEXTURE texture = NULL);
	~hgeFont();
...
private:
    ...
    void        _init(const char *filename, void *data, DWORD size,
                      HTEXTURE texture= NULL, bool bMipmap=false);
